 ...
 * 2008-6-11
 */
package encryptDecrypt.zlex.chapter09_3ECDSA;
...
public class ECDSACoderTest {
	...
	static class ECDSACoder {

		/**
		 * 数字签名 密钥算法
		 */
		private static final String KEY_ECDSA = "ECDSA";
		...
		public static Map<String, Object> initKey() throws Exception {
			...
			// 实例化密钥对儿生成器
			KeyPairGenerator kpg = KeyPairGenerator.getInstance(KEY_ECDSA);
		...
		public static byte[] sign(byte[] data, byte[] privateKey) throws Exception {
			...
			// 实例化密钥工厂
			KeyFactory keyFactory = KeyFactory.getInstance(KEY_ECDSA);
