 ...
 *  Dependencies: _015ThreeSum.java Stopwatch.java StdRandom.java StdOut.java
 *
 *  % java DoublingTest 
 *      250     0.0
 *      500     0.0
...
public class DoublingTest {
    ...
    /**
     * Returns the amount of time to call {@code _015ThreeSum.count()} with <em>n</em>
     * random 6-digit integers.
     * @param n the number of integers
     * @return amount of time (in seconds) to call {@code _015ThreeSum.count()}
    ...
    /**
     * Prints table of running times to call {@code _015ThreeSum.count()}
