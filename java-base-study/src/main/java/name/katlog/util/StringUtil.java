...
import name.katlog.util.algorithmImpl.StringImpl;
...
public final class StringUtil {
     ...
     * @return 处理后的字符串
     */
    public  static String joinString(Collection list, String symbol) {
    ...
    public  static String joinString(Collection list, String symbol, String prefix, String subfix) {
     ...
     * @return
     */
    public static String splitRemoveDuplicates(String str,String splitStr){
        if (isEmpty(str)) {
            return "" ;
        }
        String[] splits = str.split(splitStr);
        Set<String> stringSet = new LinkedHashSet<>(Arrays.asList(splits));
        return joinString(stringSet, splitStr);
    }
