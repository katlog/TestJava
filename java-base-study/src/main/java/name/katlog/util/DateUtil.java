...
public final class DateUtil {
     ...
     * @return
     */
    public static Date getDailyStartTime(Long timeStamp, String timeZone) {
     ...
     * @return
     */
    public static Date getDailyEndTime(Long timeStamp, String timeZone) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeZone(TimeZone.getTimeZone(timeZone));
        calendar.setTimeInMillis(timeStamp);
    ...
    public static String timestampToStr(Date timestamp, String zoneId) {
        ZoneId timezone = ZoneId.of(zoneId);
        LocalDateTime localDateTime = LocalDateTime.ofInstant(timestamp.toInstant(), timezone);
        return localDateTime.toString();
    }
}
