...
public final class RegUtil {
    ...
    public static String getFirstMatchStr(String content, String pattren) {
        return getSpecifiedMatchStr(content, pattren, 1);
    }

    public static String getFirstMatcherBracketStr(String content, String pattren) {
    ...
    public static String getSpecifiedMatchStr(String content, String pattren, int num) {
