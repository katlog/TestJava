// Adding a toString _03method to PhoneNumber - page 52
package name.fw.effectivejava.examples.chapter03.item10;
...
public final class PhoneNumber {
	...
	public static void main(String[] args) {
		...
		try {
            PhoneNumber clone = (PhoneNumber) phoneNumber.clone();
